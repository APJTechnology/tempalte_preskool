        ...
        <div class="card-body">
          <div class="inovices-widget-header">
            <span class="inovices-widget-icon">
              <img
                src="../../../../assets/img/icons/invoices-icon1.svg"
                alt=""
              />
            </span>
      ...
      <div class="card inovices-card">
        <div class="card-body">
          <div class="inovices-widget-header">
            <span class="inovices-widget-icon">
              <img
                src="../../../../assets/img/icons/invoices-icon2.svg"
                alt=""
              />
            </span>
            <div class="inovices-dash-count">
      ...
      <div class="card inovices-card">
        <div class="card-body">
          <div class="inovices-widget-header">
            <span class="inovices-widget-icon">
              <img
                src="../../../../assets/img/icons/invoices-icon3.svg"
                alt=""
              />
            </span>
            <div class="inovices-dash-count">
      ...
      <div class="card inovices-card">
        <div class="card-body">
          <div class="inovices-widget-header">
            <span class="inovices-widget-icon">
              <img
                src="../../../../assets/img/icons/invoices-icon4.svg"
                alt=""
              />
            </span>
            <div class="inovices-dash-count">
