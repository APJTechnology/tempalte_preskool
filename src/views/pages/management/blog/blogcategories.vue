        ...
        <div class="page-header">
          <div class="row">
            ...
            <div class="col-auto text-end">
              <a
                href="javascript:;"
                class="btn btn-primary btn-blog mb-3"
            ...
            <div class="card categories-table">
              <div class="card-body">
                <div class="table-responsive">
                  <table
                    class="table custom-table mb-0 datatable"
                    id="subjectstable"
                  >
                    <thead>
                      <tr>
              ...
              <div class="bank-inner-details">
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                      <label
                        >Description (Meta Tag)<span class="text-danger"
                          >*</span
                        ></label
                      >
                      <input
                  ...
                  <div class="col-lg-12 col-md-12">
                    <div class="form-group">
                      <label
                        >Keywords (Meta Tag)<span class="text-danger"
                          >*</span
                        ></label
                      >
                      <input
