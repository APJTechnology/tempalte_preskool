            ...
            <div class="blog-view">
              <div class="blog-single-post">
                <router-link to="/blog" class="back-btn"
                  ><i class="feather-chevron-left"></i> Back</router-link
                >
                ...
                <div class="blog-info">
                  <div class="post-list">
                    <ul>
                        ...
                        <div class="post-author">
                          <router-link to="/profile"
                            ><img
                              ...
                              alt="Post Author"
                            />
                            <span>by Prof. Lester </span></router-link
                          >
                        </div>
                      </li>
                      ...
                      <li>
                        <i class="feather-grid"></i> Set Theory, Mathematician
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="about-author">
                    ...
                    <div class="author-details">
                      <router-link to="/profile" class="blog-author-name"
                        >Prof. Darren Elder
                        <span>Team Lead, Male, 40 Years Old</span></router-link
                      >
                      <p class="mb-0">
                          ...
                          <div class="comment-by">
                            <h5 class="blog-author-name">
                              ...
                              <span class="blog-date">
                                <i class="feather-clock me-1"></i>Dec 6,
                                2017</span
                              >
                            </h5>
                          </div>
                            ...
                            <div class="comment-block">
                              <div class="comment-by">
                                <h5 class="blog-author-name">
                                  Gina Moore
                                  <span class="blog-date">
                                    <i class="feather-clock me-1"></i> 6 Dec
                                    2022</span
                                  >
                                </h5>
                              </div>
                            ...
                            <div class="comment-block">
                              <div class="comment-by">
                                <h5 class="blog-author-name">
                                  Carl Kelly
                                  <span class="blog-date">
                                    <i class="feather-clock me-1"></i> 7 Dec
                                    2022</span
                                  >
                                </h5>
                              </div>
                        ...
                        <div class="comment-block">
                          <div class="comment-by">
                            <h5 class="blog-author-name">
                              Joan Gardner
                              <span class="blog-date">
                                <i class="feather-clock me-1"></i> 12 Dec
                                2022</span
                              >
                            </h5>
                          </div>
                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="form-floating mb-3">
                      ...
                      />
                      <label for="floatingInput"
                        >Your Email address<span class="text-danger"
                          >*</span
                        ></label
                      >
                    </div>
                    ...
                    <div class="submit-section">
                      <button
                        class="submit-btn btn-primary btn-blog"
                        type="submit"
                      >
                        Submit
                      </button>
              ...
              <div class="card blog-share clearfix">
                ...
                <div class="card-body">
                  <ul class="social-share">
                    <li>
                      <a href="javascript:;"><i class="feather-twitter"></i></a>
                    </li>
                    <li>
                      <a href="javascript:;"
                    ...
                    <li>
                      <a href="javascript:;"><i class="feather-youtube"></i></a>
                    </li>
                  </ul>
                </div>
              </div>
