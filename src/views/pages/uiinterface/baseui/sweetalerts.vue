          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <b-button
                  ...
                  @click="positionTopstart"
                >
                  Top Start
                </b-button>
                <b-button
                  variant="outline-success me-1 mb-1"
                  @click="positionTopend"
                >
                  Top End
                </b-button>
                <b-button
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p>
                  ...
                  "error", "success" and "info". You can also set it as "input"
                  to get a prompt modal. It can either be put in the object
                  under the key "icon" or passed as the third parameter of the
                  function.
                </p>
                <b-button
                  variant="outline-success me-1 mb-1"
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p>
                  Use
                  <code>confirmButtonClass: "btn btn-{colorName}"</code> option
