        ...
        <div class="card bg-white">
          ...
          <div class="card-body">
            <div class="row row-sm align-items-center">
              ...
              <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                <b-button variant="outline-secondary btn-block"
                  >Secondary</b-button
                >
              </div>
              <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
            ...
            <div class="row row-sm align-items-center mt-3">
              ...
              <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                <b-button variant="outline-danger btn-block active"
                  >Danger</b-button
                >
              </div>
              <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                <b-button variant="outline-info btn-block active"
                  >Info</b-button
                >
              </div>
              <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                <b-button variant="outline-light btn-block active"
                  >Light</b-button
                >
              </div>
              <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                <b-button variant="outline-dark btn-block active"
                  >Dark</b-button
                >
              </div>
            </div>
            <div class="row row-sm align-items-center mt-3">
              ...
              <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                <b-button disabled variant="outline-info btn-block"
                  >Info</b-button
                >
              </div>
              <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                <b-button disabled variant="outline-light btn-block"
                  >Light</b-button
                >
              </div>
              <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                <b-button disabled variant="outline-dark btn-block"
                  >Dark</b-button
                >
              </div>
            </div>
