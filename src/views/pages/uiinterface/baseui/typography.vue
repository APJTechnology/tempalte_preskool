        ...
        <div class="row">
          ...
          <div class="col-md-4 d-flex">
            <div class="card flex-fill bg-white">
              ...
              <div class="card-body">
                <p>
                  <a href="javascript:;" class="text-primary">Primary link</a>
                </p>
                <p>
                ...
                <p>
                  <a href="javascript:;" class="text-success">Success link</a>
                </p>
                <p>
                  <a href="javascript:;" class="text-danger">Danger link</a>
                </p>
                <p>
                  <a href="javascript:;" class="text-warning">Warning link</a>
                </p>
                <p><a href="javascript:;" class="text-info">Info link</a></p>
                <p>
                  <a href="javascript:;" class="text-light bg-dark"
                    >Light link</a
                  >
                </p>
                ...
                <p>
                  <a href="javascript:;" class="text-white bg-dark mb-0"
                    >White link</a
                  >
                </p>
              </div>
